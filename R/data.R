...
#' @docType data
#' @description The data consist of 4601 email items, of which 1813 items were identified as spam.
...
#' \item \code{yesno}: outcome variable, a factor with levels \code{n} not spam, \code{y} spam
#' }
#' @examples
#' require(rpart)
...
#'
#' These data are available from the University of California at Irvine Repository of Machine Learning Databases and Domain Theories. The address is: \url{https://archive.ics.uci.edu/ml/index.php}
#'
#' Also available in the DAAG R package.
#'
#' John H. Maindonald and W. John Braun (2019). DAAG: Data Analysis and Graphics Data and Functions.
